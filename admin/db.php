...
// ============================================================
//  1.  PATH CONFIGURATION (from config.php)
// ============================================================

// Include config if not already loaded
if (!defined('IRTIJA_ROOT')) {
...
// ============================================================
//  3.  HELPER FUNCTIONS (for convenience)
// ============================================================
...
function db_log_error(string $message, array $context = [], string $level = 'error'): void
{
    ...
    $logFile = IRTIJA_LOG_DIR . '/db_errors.log';
...
// ============================================================
//  5.  AUTO-CREATE DATABASE SCHEMA (on first run)
// ============================================================
...
// Only run this check if we're not in a public page context (to avoid unnecessary DB checks)
